...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-6 text-right"><a href="/suppliers/create" class="btn btn-success">Create New Supplier</a></div>
    </div>
    ...
    @if(count($suppliers) > 0)
        <table class="table table-striped table-light">
            ...
            @foreach ($suppliers as $supplier)
                <tr>
                    <td><a href="/suppliers/{{$supplier->Supplier_id}}" title="View supplier info">{{$supplier->Supplier_id}}</a></td>
